    ...
    >
      ...
      >
        <div className='w-7/12 flex text-center flex-col gap-5'>
          ...
          <Button className='m-auto transition-all text-center bg-orange-700 duration-500 hover:bg-orange-800 hover:text-black w-9/12 px-5 py-5 flex justify-between' href='/contact'>Book Now</Button>
        </div>
      </div>
    </Box>
  ) : null}
